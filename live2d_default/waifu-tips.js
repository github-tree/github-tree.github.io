...
function loadWidget(config) {
	...
	async function loadModel(modelId, modelTexturesId, message) {
		...
		if (useCDN) {
			...
			loadlive2d("live2d", `./live2d_default/data/3-70.json`);
...
function initWidget(config, apiPath = "/") {
	...
	document.body.insertAdjacentHTML("beforeend", `
		<div class="live2d-tool hide-live2d no-select" id="show_model" style="visibility: hidden"><div class="keys">Hide</div></div>
		<div class="live2d-tool live2d-pio no-select" id="switch_live2d" style="visibility: hidden"><div class="keys">切换</div></div>
		<div class="live2d-tool switch-live2d no-select" id="switch_model" style="visibility: hidden"><div class="keys">换装</div></div>
		<div class="live2d-tool save-live2d no-select" id="save_pic"  style="visibility: hidden"><div class="keys">Save</div></div>
		`);
